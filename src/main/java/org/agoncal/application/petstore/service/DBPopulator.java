...
public class DBPopulator {
    ...
    private void initCatalog() {
        ...
        largeAngelfish.setId(largeAngelfish.getType() + "_" + largeAngelfish.getName());
        ...
        thootlessAngelfish.setId(thootlessAngelfish.getType() + "_" + thootlessAngelfish.getName());
        ...
        spottedTigerShark.setId(spottedTigerShark.getType() + "_" + spottedTigerShark.getName());
        ...
        spotlessTigerShark.setId(spotlessTigerShark.getType() + "_" + spotlessTigerShark.getName());
        ...
        maleKoi.setId(maleKoi.getType() + "_" + maleKoi.getName());
        ...
        femaleKoi.setId(femaleKoi.getType() + "_" + femaleKoi.getName());
        koi.addItem(maleKoi);
        ...
        maleGoldfish.setId(maleGoldfish.getType() + "_" + maleGoldfish.getName());
        ...
        femaleGoldfish.setId(femaleGoldfish.getType() + "_" + femaleGoldfish.getName());
        ...
        maleBulldog.setId(maleBulldog.getType() + "_" + maleBulldog.getName());
        ...
        femaleBulldog.setId(femaleBulldog.getType() + "_" + femaleBulldog.getName());
        ...
        malePoodle.setId(malePoodle.getType() + "_" + malePoodle.getName());
        ...
        femalePoodle.setId(femalePoodle.getType() + "_" + femalePoodle.getName());
        ...
        tailedDalmation.setId(tailedDalmation.getType() + "_" + tailedDalmation.getName());
        ...
        tailessDalmation.setId(tailessDalmation.getType() + "_" + tailessDalmation.getName());
        ...
        tailedGoldenRetriever.setId(tailedGoldenRetriever.getType() + "_" + tailedGoldenRetriever.getName());
        ...
        tailessGoldenRetriever.setId(tailessGoldenRetriever.getType() + "_" + tailessGoldenRetriever.getName());
        ...
        tailedLabradorRetriever.setId(tailedLabradorRetriever.getType() + "_" + tailedLabradorRetriever.getName());
        ...
        tailessLabradorRetriever.setId(tailessLabradorRetriever.getType() + "_" + tailessLabradorRetriever.getName());
        ...
        maleChihuahua.setId(maleChihuahua.getType() + "_" + maleChihuahua.getName());
        ...
        femaleChihuahua.setId(femaleChihuahua.getType() + "_" + femaleChihuahua.getName());
        ...
        femaleRattlesnake.setId(femaleRattlesnake.getType() + "_" + femaleRattlesnake.getName());
        ...
        maleRattlesnake.setId(maleRattlesnake.getType() + "_" + maleRattlesnake.getName());
        ...
        femaleIguana.setId(femaleIguana.getType() + "_" + femaleIguana.getName());
        ...
        maleIguana.setId(maleIguana.getType() + "_" + maleIguana.getName());
        ...
        maleManx.setId(maleManx.getType() + "_" + maleManx.getName());
        ...
        femaleManx.setId(femaleManx.getType() + "_" + femaleManx.getName());
        ...
        malePersian.setId(malePersian.getType() + "_" + malePersian.getName());
        ...
        femalePersian.setId(femalePersian.getType() + "_" + femalePersian.getName());
        ...
        maleAmazonParrot.setId(maleAmazonParrot.getType() + "_" + maleAmazonParrot.getName());
        ...
        femaleAmazonParrot.setId(femaleAmazonParrot.getType() + "_" + femaleAmazonParrot.getName());
        ...
        maleFinch.setId(maleFinch.getType() + "_" + maleFinch.getName());
        ...
        femaleFinch.setId(femaleFinch.getType() + "_" + femaleFinch.getName());
