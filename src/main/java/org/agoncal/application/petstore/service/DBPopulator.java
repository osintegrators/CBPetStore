...
public class DBPopulator {
    ...
    private void initCatalog() {
        ...
        rattlesnake.setId(rattlesnake.getType() + "_" + rattlesnake.getName());
        Product iguana = new Product("Iguana", "Friendly green friend", reptile);
        iguana.setId(iguana.getType() + "_" + iguana.getName());
        ...
        maleKoi.setId(maleKoi.getType() + "_" + koi.getName() + "_" + maleKoi.getName());
        ...
        femaleKoi.setId(femaleKoi.getType() + "_" + koi.getName() + "_" + femaleKoi.getName());
        koi.addItem(maleKoi);
        ...
        maleGoldfish.setId(maleGoldfish.getType() + "_" + goldfish.getName() + "_" + maleGoldfish.getName());
        ...
        femaleGoldfish.setId(femaleGoldfish.getType() + "_" + goldfish.getName() + "_" + femaleGoldfish.getName());
        ...
        maleBulldog.setId(maleBulldog.getType() + "_" + bulldog.getName() + "_" + maleBulldog.getName());
        ...
        femalePoodle.setId(femalePoodle.getType() + "_" + poodle.getName() + "_" + femalePoodle.getName());
        ...
        tailedDalmation.setId(tailedDalmation.getType() + "_" + dalmation.getName() + "_" + tailedDalmation.getName());
        ...
        tailessDalmation.setId(tailessDalmation.getType() + "_" + dalmation.getName() + "_" + tailessDalmation.getName());
        ...
        tailedGoldenRetriever.setId(tailedGoldenRetriever.getType() + "_" + goldenRetriever.getName() + "_" + tailedGoldenRetriever.getName());
        ...
        tailessGoldenRetriever.setId(tailessGoldenRetriever.getType() + "_" + goldenRetriever.getName() + "_" + tailessGoldenRetriever.getName());
        ...
        tailedLabradorRetriever.setId(tailedLabradorRetriever.getType() + "_" + labradorRetriever.getName() + "_" + tailedLabradorRetriever.getName());
        ...
        tailessLabradorRetriever.setId(tailessLabradorRetriever.getType() + "_" + labradorRetriever.getName() + "_" + tailessLabradorRetriever.getName());
        ...
        maleChihuahua.setId(maleChihuahua.getType() + "_" + chihuahua.getName() + "_" + maleChihuahua.getName());
        ...
        femaleChihuahua.setId(femaleChihuahua.getType() + "_" + chihuahua.getName() + "_" + femaleChihuahua.getName());
        ...
        femaleRattlesnake.setId(femaleRattlesnake.getType() + "_" + rattlesnake.getName() + "_" + femaleRattlesnake.getName());
        ...
        maleRattlesnake.setId(maleRattlesnake.getType() + "_" + rattlesnake.getName() + "_" + maleRattlesnake.getName());
        ...
        femaleIguana.setId(femaleIguana.getType() + "_" + iguana.getName() + "_" + femaleIguana.getName());
        ...
        maleIguana.setId(maleIguana.getType() + "_" + iguana.getName() + "_" + maleIguana.getName());
        ...
        maleManx.setId(maleManx.getType() + "_" + manx.getName() + "_" + maleManx.getName());
        ...
        femaleManx.setId(femaleManx.getType() + "_" + manx.getName() + "_" + femaleManx.getName());
        ...
        malePersian.setId(malePersian.getType() + "_" + persian.getName() + "_" + malePersian.getName());
        ...
        femalePersian.setId(femalePersian.getType() + "_" + persian.getName() + "_" + femalePersian.getName());
        ...
        maleAmazonParrot.setId(maleAmazonParrot.getType() + "_" + amazonParrot.getName() + "_" + maleAmazonParrot.getName());
        ...
        femaleAmazonParrot.setId(femaleAmazonParrot.getType() + "_" + amazonParrot.getName() + "_" + femaleAmazonParrot.getName());
        ...
        maleFinch.setId(maleFinch.getType() + "_" + finch.getName() + "_" + maleFinch.getName());
        ...
        femaleFinch.setId(femaleFinch.getType() + "_" + finch.getName() + "_" + femaleFinch.getName());
